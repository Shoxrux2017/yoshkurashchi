...
class MushaklarScreen extends StatefulWidget {
  final int mushaklarId;
  const MushaklarScreen({super.key, required this.mushaklarId});

  @override
  State<MushaklarScreen> createState() => _MushaklarScreenState();
}

class _MushaklarScreenState extends State<MushaklarScreen> {
  late VideoPlayerController _controller;
  var _url = "";
  List info = [];
  Future<void> _initData() async {
    await DefaultAssetBundle.of(context)
        .loadString("json/mushaklar/lesson${widget.mushaklarId + 1}.json")
        .then((value) {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Container(
                        ...
                        child: Text(
                          (info[index]["title_img"]).toUpperCase(),
